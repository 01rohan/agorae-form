                    ...
                    <div className="card-body">
                        <ul className="nav nav-tabs">
                            <li className="nav-item">
                                <a onClick={(e) => { e.preventDefault(); this.setState({ tab: 'content' }) }} className={this.state.tab === 'content' ? 'nav-link active' : 'nav-link'} href="/content">Edit</a>
                            </li>
                            <li className="nav-item">
                        ...
                        <div className="content" hidden={this.state.tab !== 'content'}>
                            <div className="card-body">
                                ...
                                <div className="form-group">
                                    <label className="label" htmlFor="paragraph">Text Area</label>
