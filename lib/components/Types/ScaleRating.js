...
var ScaleRating = function (_Component) {
    _inherits(ScaleRating, _Component);

    function ScaleRating(props) {
        _classCallCheck(this, ScaleRating);

        var _this = _possibleConstructorReturn(this, (ScaleRating.__proto__ || Object.getPrototypeOf(ScaleRating)).call(this, props));
