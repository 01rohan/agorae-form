...
var BulletList = function (_Component) {
    _inherits(BulletList, _Component);

    function BulletList(props) {
        _classCallCheck(this, BulletList);

        var _this = _possibleConstructorReturn(this, (BulletList.__proto__ || Object.getPrototypeOf(BulletList)).call(this, props));
