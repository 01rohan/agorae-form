...
var FormContainer = function (_Component) {
    ...
    _createClass(FormContainer, [{
        ...
        value: function catchField(data) {
            ...
            var tools = ["SINGLE_FIELD", "SELECT_FIELD", "CHECK_BOXES", "RADIO_BUTTONS", "PARAGRAPH", "DURATION_PICKER", "DATE", "TIME", "PASSWORD", "NUMBER", "CHECKBOX", "EMAIL", "URL", "FILE", "RANGE", "TEL", "RATING", "SCALERATING"];
