...
var _Number = require('./Types/Password');
...
var _ImageUpload = require('./Types/ImageUpload');

var _ImageUpload2 = _interopRequireDefault(_ImageUpload);

var _Range = require('./Types/Range');

var _Range2 = _interopRequireDefault(_Range);

var _Tel = require('./Types/Tel');
...
var _ScaleRating = require('./Types/ScaleRating');

var _ScaleRating2 = _interopRequireDefault(_ScaleRating);
...
var _BulletList = require('./Types/BulletList');

var _BulletList2 = _interopRequireDefault(_BulletList);

var _Divider = require('./Types/Divider');

var _Divider2 = _interopRequireDefault(_Divider);

var _ImageSlider = require('./Types/ImageSlider');
    ...
    _createClass(FormContainer, [{
        ...
        value: function renderTool(field, index) {
            ...
            if (field.toolType === 'SELECT_FIELD') {
                ...
                return _react2.default.createElement(_Email2.default, {
                    changeState: function changeState(e, index) {
                        return _this4.changeChildState(e, index);
                    },
                    field: field,
                ...
                return _react2.default.createElement(_ImageUpload2.default, {
                    changeState: function changeState(e, index) {
                        return _this4.changeChildState(e, index);
                    },
                    field: field,
                ...
                return _react2.default.createElement(_Tel2.default, {
                    changeState: function changeState(e, index) {
                        return _this4.changeChildState(e, index);
                    },
                    field: field,
                ...
                return _react2.default.createElement(_ScaleRating2.default, {
                    changeState: function changeState(e, index) {
                        return _this4.changeChildState(e, index);
                    },
                    field: field,
                ...
                return _react2.default.createElement(_BulletList2.default, {
                    changeState: function changeState(e, index) {
                        return _this4.changeChildState(e, index);
                    },
                    field: field,
                ...
                return _react2.default.createElement(_ImageSlider2.default, {
                    changeState: function changeState(e, index) {
                        return _this4.changeChildState(e, index);
                    },
                    field: field,
        ...
        value: function catchField(data) {
            ...
            var tools = ["SINGLE_FIELD", "SELECT_FIELD", "CHECK_BOXES", "RADIO_BUTTONS", "PARAGRAPH", "DURATION_PICKER", "DATE", "TIME", "PASSWORD", "NUMBER", "CHECKBOX", "EMAIL", "URL", "FILE", "RANGE", "TEL", "RATING", "SCALERATING", "IMAGE_SLIDER", "DIVIDER"];
